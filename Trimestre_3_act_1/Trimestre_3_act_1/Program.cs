        ...
        static void Main(string[] args)
        {
            ...
            switch (Menu)
            {
                ...
                case 7:
                    ...
                    int[] v = { 12, 50, 23, 10, 18, 35, 41, 85, 16, 45 };
                    string[] nmbre = {"juan", "maria", "tereza", "pedro", "javier", "ana","diana", "jorge", "dayana", "lady"};
                    int max = v[0], min = v[0];
                    string nommin = nmbre[0], nommax = nmbre[0];
                    ...
                    Console.Write("\n\nEl/La mayor es " + nommax + " y su edad es " + max);
                    Console.Write("\n\nEl/La menor es " + nommin + " y su edad es " + min);
                    /*int temporal;
                    string tempnom;
